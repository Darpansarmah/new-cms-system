...
<h6 class="h3 mb-4 mt-4 text-gray-800">User Roles</h6>
          ...
          <div class="table-responsive">
            ...
            @foreach($roles as $role)
                ...
                <tr>  
                  ...
                  <td>{{ $role->slug }}</td> 
                  <td> 
                    <form action="{{ route('users.roles.attach', $user) }}" method="post">
                      @csrf
                      @method('PUT')
                  ...
                  <td> 
                    <form action="{{ route('users.roles.detach', $user) }}" method="post">
                    @csrf
                    @method('DELETE')
